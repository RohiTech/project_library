VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rpt_Venta_Contado_Admon 
   Caption         =   "Reporte del detalle de las ventas al contado del Administrador"
   ClientHeight    =   7860
   ClientLeft      =   105
   ClientTop       =   405
   ClientWidth     =   9945
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   6810
         Object.Height          =   1140
         Picture         =   "rpt_Venta_Contado_Admon.dsx":0000
      EndProperty
      ItemType1       =   3
   ...
   EndProperty
End
Attribute VB_Name = "rpt_Venta_Contado_Admon"
...
Private Sub DataReport_Terminate()
    Libro_de_Ventas_Admon.rst1.Close
End Sub
