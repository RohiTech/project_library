VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rpt_Total_Venta_Contado_Admon 
   Caption         =   "Reporte de las ventas al contado del Administrador"
   ClientHeight    =   6900
   ClientLeft      =   120
   ClientTop       =   405
   ClientWidth     =   9540
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   6810
         Object.Height          =   1140
         Picture         =   "rpt_Total_Venta_Contado_Admon.dsx":0000
      EndProperty
      ItemType1       =   3
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Reporte venta al contado"
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   EndProperty
End
Attribute VB_Name = "rpt_Total_Venta_Contado_Admon"
...
Private Sub DataReport_Terminate()
    Libro_de_Ventas_Admon.rst3.Close
End Sub
