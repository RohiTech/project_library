...
frmconectar.Visible = False

Timer1.Enabled = False

Skin1.ApplySkin hWnd

txtusuario.Text = "sa" ' "Jose Francisco"
txtcontraseña.Text = "sa" ' "Lucky"
txtservidor.Text = UCase(Winsock1.LocalHostName) ' UCase(Winsock1.LocalHostName) & "\SISTEMA"
txtbasedatos.Text = "CLARO"
...
With Principal
    ...
    Select Case tipo
        ...
        Case "Arqueador(a)"
            ...
            .mnuAdministrador.Item(23).Enabled = False
            '.mnuSistema.Item(9).Enabled = False
            '.mnuCambioMoneda.Item(40).Enabled = False
        Case "Vendedor(a)"
    End Select
    .Show
End With
